...
export default function ProductCatalogPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    const list = allProducts.filter((product) => {
      ...
      const matchesPromotion = !onlyPromotions || Boolean(product.originalPrice)
    ...
    list.sort((a, b) => {
      switch (sortBy) {
        ...
        default:
          return (
            Number(Boolean(b.discountPercent)) - Number(Boolean(a.discountPercent)) ||
            b.rating - a.rating ||
    ...
    return list
  }, [category, minimumRating, onlyInStock, onlyPromotions, priceRange, query, sortBy])
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="mx-auto max-w-7xl px-4 py-10 lg:py-12">
          ...
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground lg:text-base">
            Encontre tecnologia com filtros completos de categoria, preco, avaliacao e
            promocoes.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-3 border-t border-border pt-4">
                <div className="flex items-center gap-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setOnlyPromotions(checked === true)}
                  />
